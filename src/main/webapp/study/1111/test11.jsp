	...
	<script>
		...
		function fCheck() {
			...
			if(name == "") {
				alert("이름을 입력하세요.");
				myform.name.focus();
				return false; // else면 이게 필요없다하심
			}
			else {
				myform.submit(); // 앞에꺼가 잘 처리 됐으면 전송을 해라
			}
		}
	</script>
</head>
...
<div class="container">
	<h2>값 전송하기(get방식)</h2>
  <!-- <form name="myform" method="get" action="../../atom/t7"> --> <!-- 2개 올라가야 webapp이라서 ../../ -->
  <form name="myform" method="post" action="../../test11Ok"> <!-- 2개 올라가야 webapp이라서 ../../ -->
